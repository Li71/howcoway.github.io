...
; (function ($, window, document, undefined) {
    ...
    _default.settings = {
        ...
        nodeIcon: '',  //所有節點的默認圖標
        selectedIcon: '',  //節點被選中時顯示的圖標     String
        ...
        color: undefined, // '#000000',  //所有節點使用的默認前景色，這個顏色會被節點數據上的backColor屬性覆蓋.        String
        backColor: undefined, // '#FFFFFF',  //所有節點使用的默認背景色，這個顏色會被節點數據上的backColor屬性覆蓋.     String
        borderColor: undefined, // '#dddddd',  //邊框顏色。如果不想要可見的邊框，則可以設置showBorder為false。        String
        onhoverColor: '#F5F5F5',  //光標停在節點上激活的默認背景色      String
        selectedColor: '#FFFFFF',  //當節點被選中時的前景色
        selectedBackColor: '#428bca',  //當節點被選中時的背景色
        searchResultColor: '#D9534F',  //當節點被選中時的前景色
        searchResultBackColor: undefined, //'#FFFFFF',  //當節點被選中時的背景色

        enableLinks: false,
        highlightSelected: true,
        highlightSearchResults: true,
        showBorder: true,  //是否在節點周圍顯示邊框
        showIcon: false,  //是否顯示節點圖標
